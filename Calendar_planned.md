...
28-30	| Vertical dimension and thermo: PV as the ultimate conserved variable. Stability reasoning based on conserved variables. |The complete, formally closed set of primitive equations (PE). **Reading: through 7.3.5**.
5-7 Oct	||
12-14	| | 
